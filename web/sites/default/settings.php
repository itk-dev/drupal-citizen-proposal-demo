 ...
 * @endcode
 */
$settings['hash_salt'] = 'HqobThjlsyduycW5l2aZyfbZyo75wIxqhN21eV2-aei_t-Z6kelMyvlsVvwYVKVETYz9qD5tTg';
...
// Cf. https://github.com/itk-dev/drupal-citizen-proposal/blob/main/modules/citizen_proposal_openid_connect/README.md
$settings['citizen_proposal_openid_connect']['openid_connect'] = [
  'clientId'                 => 'client-id',
  'clientSecret'             => 'client-secret',
  'openIDConnectMetadataUrl' => 'http://idp-citizen.drupal-citizen-proposal.local.itkdev.dk/.well-known/openid-configuration',
  'allowHttp' => TRUE,

  // Map claims to expected keys
  'claims' => [
